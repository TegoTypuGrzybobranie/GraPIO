...
public class GameController implements Initializable {
    ...
    private final List<ImageView> fieldsImg = new ArrayList<>();
    ...
    public void throwDice() {
        ...
        fieldsImg.get(roll).setImage(new Image(Objects.requireNonNull(getClass().getResourceAsStream("images/players/1.png"))));
    }
